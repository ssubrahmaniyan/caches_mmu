...
tbfile=open('dm_writethrough_tb.bsv','r')
...
# A load miss followed by a store hit , which is again followed by a load miss 
...
# A load miss followed by a store miss , which is again followed by a delay  
# and a store hit to the previous address
